...
class QsciScintillaBase(QtWidgets.QAbstractScrollArea):
    ...
    QSCN_SELCHANGED: PYQT_SIGNAL
    SCEN_CHANGE: PYQT_SIGNAL
    SCN_AUTOCCANCELLED: PYQT_SIGNAL
    SCN_AUTOCCHARDELETED: PYQT_SIGNAL
    SCN_AUTOCCOMPLETED: PYQT_SIGNAL
    SCN_AUTOCSELECTION: PYQT_SIGNAL
    SCN_AUTOCSELECTIONCHANGE: PYQT_SIGNAL
    SCN_CALLTIPCLICK: PYQT_SIGNAL
    SCN_CHARADDED: PYQT_SIGNAL
    SCN_DOUBLECLICK: PYQT_SIGNAL
    SCN_DWELLEND: PYQT_SIGNAL
    SCN_DWELLSTART: PYQT_SIGNAL
    SCN_FOCUSIN: PYQT_SIGNAL
    SCN_FOCUSOUT: PYQT_SIGNAL
    SCN_HOTSPOTCLICK: PYQT_SIGNAL
    SCN_HOTSPOTDOUBLECLICK: PYQT_SIGNAL
    SCN_HOTSPOTRELEASECLICK: PYQT_SIGNAL
    SCN_INDICATORCLICK: PYQT_SIGNAL
    SCN_INDICATORRELEASE: PYQT_SIGNAL
    SCN_MACRORECORD: PYQT_SIGNAL
    SCN_MARGINCLICK: PYQT_SIGNAL
    SCN_MARGINRIGHTCLICK: PYQT_SIGNAL
    SCN_MODIFIED: PYQT_SIGNAL
    SCN_MODIFYATTEMPTRO: PYQT_SIGNAL
    SCN_NEEDSHOWN: PYQT_SIGNAL
    SCN_PAINTED: PYQT_SIGNAL
    SCN_SAVEPOINTLEFT: PYQT_SIGNAL
    SCN_SAVEPOINTREACHED: PYQT_SIGNAL
    SCN_STYLENEEDED: PYQT_SIGNAL
    SCN_UPDATEUI: PYQT_SIGNAL
    SCN_URIDROPPED: PYQT_SIGNAL
    SCN_USERLISTSELECTION: PYQT_SIGNAL
    SCN_ZOOM: PYQT_SIGNAL
    ...
    @overload
    def SendScintilla(self, msg: int, wParam: int, col: typing.Union[QtGui.QColor, int]) -> int: ...
    @overload
    def SendScintilla(self, msg: int, col: typing.Union[QtGui.QColor, int]) -> int: ...
    @overload
...
class QsciScintilla(QsciScintillaBase):
    ...
    indicatorClicked: PYQT_SIGNAL
    indicatorReleased: PYQT_SIGNAL
    linesChanged: PYQT_SIGNAL
    marginClicked: PYQT_SIGNAL
    marginRightClicked: PYQT_SIGNAL
    modificationAttempted: PYQT_SIGNAL
    modificationChanged: PYQT_SIGNAL
    selectionChanged: PYQT_SIGNAL
    textChanged: PYQT_SIGNAL
    userListActivated: PYQT_SIGNAL

    WrapIndentMode: typing.Type[int]
    #class WrapIndentMode(int): ...
    WrapIndentFixed = ... # type: int
    WrapIndentSame = ... # type: int
    WrapIndentIndented = ... # type: int
    WrapIndentDeeplyIndented = ... # type: int

    WrapVisualFlag: typing.Type[int]
    #class WrapVisualFlag(int): ...
    WrapFlagNone = ... # type: int
    WrapFlagByText = ... # type: int
    WrapFlagByBorder = ... # type: int
    WrapFlagInMargin = ... # type: int

    WrapMode: typing.Type[int]
    #class WrapMode(int): ...
    WrapNone = ... # type: int
    WrapWord = ... # type: int
    WrapCharacter = ... # type: int
    WrapWhitespace = ... # type: int

    WhitespaceVisibility: typing.Type[int]
    #class WhitespaceVisibility(int): ...
    WsInvisible = ... # type: int
    WsVisible = ... # type: int
    WsVisibleAfterIndent = ... # type: int
    WsVisibleOnlyInIndent = ... # type: int

    TabDrawMode: typing.Type[int]
    #class TabDrawMode(int): ...
    TabLongArrow = ... # type: int
    TabStrikeOut = ... # type: int

    MarkerSymbol: typing.Type[int]
    #class MarkerSymbol(int): ...
    Circle = ... # type: int
    Rectangle = ... # type: int
    RightTriangle = ... # type: int
    SmallRectangle = ... # type: int
    RightArrow = ... # type: int
    Invisible = ... # type: int
    DownTriangle = ... # type: int
    Minus = ... # type: int
    Plus = ... # type: int
    VerticalLine = ... # type: int
    BottomLeftCorner = ... # type: int
    LeftSideSplitter = ... # type: int
    BoxedPlus = ... # type: int
    BoxedPlusConnected = ... # type: int
    BoxedMinus = ... # type: int
    BoxedMinusConnected = ... # type: int
    RoundedBottomLeftCorner = ... # type: int
    LeftSideRoundedSplitter = ... # type: int
    CircledPlus = ... # type: int
    CircledPlusConnected = ... # type: int
    CircledMinus = ... # type: int
    CircledMinusConnected = ... # type: int
    Background = ... # type: int
    ThreeDots = ... # type: int
    ThreeRightArrows = ... # type: int
    FullRectangle = ... # type: int
    LeftRectangle = ... # type: int
    Underline = ... # type: int
    Bookmark = ... # type: int

    MarginType: typing.Type[int]
    #class MarginType(int): ...
    SymbolMargin = ... # type: int
    SymbolMarginDefaultForegroundColor = ... # type: int
    SymbolMarginDefaultBackgroundColor = ... # type: int
    NumberMargin = ... # type: int
    TextMargin = ... # type: int
    TextMarginRightJustified = ... # type: int
    SymbolMarginColor = ... # type: int

    MoNone = ... # type: int
    MoSublineSelect = ... # type: int

    IndicatorStyle: typing.Type[int]
    #class IndicatorStyle(int): ...
    PlainIndicator = ... # type: int
    SquiggleIndicator = ... # type: int
    TTIndicator = ... # type: int
    DiagonalIndicator = ... # type: int
    StrikeIndicator = ... # type: int
    HiddenIndicator = ... # type: int
    BoxIndicator = ... # type: int
    RoundBoxIndicator = ... # type: int
    StraightBoxIndicator = ... # type: int
    FullBoxIndicator = ... # type: int
    DashesIndicator = ... # type: int
    DotsIndicator = ... # type: int
    SquiggleLowIndicator = ... # type: int
    DotBoxIndicator = ... # type: int
    SquigglePixmapIndicator = ... # type: int
    ThickCompositionIndicator = ... # type: int
    ThinCompositionIndicator = ... # type: int
    TextColorIndicator = ... # type: int
    TriangleIndicator = ... # type: int
    TriangleCharacterIndicator = ... # type: int
    GradientIndicator = ... # type: int
    CentreGradientIndicator = ... # type: int

    FoldStyle: typing.Type[int]
    #class FoldStyle(int): ...
    NoFoldStyle = ... # type: int
    PlainFoldStyle = ... # type: int
    CircledFoldStyle = ... # type: int
    BoxedFoldStyle = ... # type: int
    CircledTreeFoldStyle = ... # type: int
    BoxedTreeFoldStyle = ... # type: int

    EolMode: typing.Type[int]
    #class EolMode(int): ...
    EolWindows = ... # type: int
    EolUnix = ... # type: int
    EolMac = ... # type: int

    EdgeMode: typing.Type[int]
    #class EdgeMode(int): ...
    EdgeNone = ... # type: int
    EdgeLine = ... # type: int
    EdgeBackground = ... # type: int
    EdgeMultipleLines = ... # type: int

    CallTipsStyle: typing.Type[int]
    #class CallTipsStyle(int): ...
    CallTipsNone = ... # type: int
    CallTipsNoContext = ... # type: int
    CallTipsNoAutoCompletionContext = ... # type: int
    CallTipsContext = ... # type: int

    CallTipsPosition: typing.Type[int]
    #class CallTipsPosition(int): ...
    CallTipsBelowText = ... # type: int
    CallTipsAboveText = ... # type: int

    BraceMatch: typing.Type[int]
    #class BraceMatch(int): ...
    NoBraceMatch = ... # type: int
    StrictBraceMatch = ... # type: int
    SloppyBraceMatch = ... # type: int

    AutoCompletionUseSingle: typing.Type[int]
    #class AutoCompletionUseSingle(int): ...
    AcusNever = ... # type: int
    AcusExplicit = ... # type: int
    AcusAlways = ... # type: int

    AutoCompletionSource: typing.Type[int]
    #class AutoCompletionSource(int): ...
    AcsNone = ... # type: int
    AcsAll = ... # type: int
    AcsDocument = ... # type: int
    AcsAPIs = ... # type: int

    AnnotationDisplay: typing.Type[int]
    #class AnnotationDisplay(int): ...
    AnnotationHidden = ... # type: int
    AnnotationStandard = ... # type: int
    AnnotationBoxed = ... # type: int
    AnnotationIndented = ... # type: int
    ...
    #def marginRightClicked(self, margin: int, line: int, state: typing.Union[int, int]) -> None: ...
    #def marginClicked(self, margin: int, line: int, state: typing.Union[int, int]) -> None: ...
    #def linesChanged(self) -> None: ...
    #def indicatorReleased(self, line: int, index: int, state: typing.Union[int, int]) -> None: ...
    #def indicatorClicked(self, line: int, index: int, state: typing.Union[int, int]) -> None: ...
    ...
    def setWhitespaceVisibility(self, mode: int) -> None: ...
    def setUtf8(self, cp: bool) -> None: ...
    def setText(self, text: str) -> None: ...
    def setTabWidth(self, width: int) -> None: ...
    def setTabIndents(self, indent: bool) -> None: ...
    def setSelectionForegroundColor(self, col: typing.Union[QtGui.QColor, int]) -> None: ...
    def setSelectionBackgroundColor(self, col: typing.Union[QtGui.QColor, int]) -> None: ...
    def setSelection(self, lineFrom: int, indexFrom: int, lineTo: int, indexTo: int) -> None: ...
    def setReadOnly(self, ro: bool) -> None: ...
    def setPaper(self, c: typing.Union[QtGui.QColor, int]) -> None: ...
    ...
    def setMarginsForegroundColor(self, col: typing.Union[QtGui.QColor, int]) -> None: ...
    def setMarginsFont(self, f: QtGui.QFont) -> None: ...
    def setMarginsBackgroundColor(self, col: typing.Union[QtGui.QColor, int]) -> None: ...
    ...
    def setIndentationGuidesForegroundColor(self, col: typing.Union[QtGui.QColor, int]) -> None: ...
    def setIndentationGuidesBackgroundColor(self, col: typing.Union[QtGui.QColor, int]) -> None: ...
    ...
    def setFolding(self, fold: int, margin: int = ...) -> None: ...
    def setEolVisibility(self, visible: bool) -> None: ...
    def setEolMode(self, mode: int) -> None: ...
    def setCursorPosition(self, line: int, index: int) -> None: ...
    def setColor(self, col: typing.Union[QtGui.QColor, int]) -> None: ...
    ...
    def setCaretLineBackgroundColor(self, col: typing.Union[QtGui.QColor, int]) -> None: ...
    def setCaretForegroundColor(self, col: typing.Union[QtGui.QColor, int]) -> None: ...
    def setBackspaceUnindents(self, unindent: bool) -> None: ...
    def setBraceMatching(self, bm: int) -> None: ...
    def setAutoIndent(self, autoindent: bool) -> None: ...
    def setAutoCompletionUseSingle(self, single: int) -> None: ...
    ...
    def whitespaceVisibility(self) -> int: ...
    ...
    def setTabDrawMode(self, mode: int) -> None: ...
    def standardCommands(self) -> QsciCommandSet: ...
    def showUserList(self, id: int, list: typing.Iterable[str]) -> None: ...
    def setWrapIndentMode(self, mode: int) -> None: ...
    def setWhitespaceSize(self, size: int) -> None: ...
    def setWhitespaceForegroundColor(self, col: typing.Union[QtGui.QColor, int]) -> None: ...
    def setWhitespaceBackgroundColor(self, col: typing.Union[QtGui.QColor, int]) -> None: ...
    ...
    def setWrapVisualFlags(self, endFlag: int, startFlag: int = ..., indent: int = ...) -> None: ...
    def resetUnmatchedBraceIndicator(self) -> None: ...
    def setUnmatchedBraceIndicator(self, indicatorNumber: int) -> None: ...
    def setUnmatchedBraceForegroundColor(self, col: typing.Union[QtGui.QColor, int]) -> None: ...
    def setUnmatchedBraceBackgroundColor(self, col: typing.Union[QtGui.QColor, int]) -> None: ...
    def resetMatchedBraceIndicator(self) -> None: ...
    def setMatchedBraceIndicator(self, indicatorNumber: int) -> None: ...
    def setMatchedBraceForegroundColor(self, col: typing.Union[QtGui.QColor, int]) -> None: ...
    def setMatchedBraceBackgroundColor(self, col: typing.Union[QtGui.QColor, int]) -> None: ...
    def setMarkerForegroundColor(self, col: typing.Union[QtGui.QColor, int], markerNumber: int = ...) -> None: ...
    def setMarkerBackgroundColor(self, col: typing.Union[QtGui.QColor, int], markerNumber: int = ...) -> None: ...
    def setMargins(self, margins: int) -> None: ...
    def clearMarginText(self, line: int = ...) -> None: ...
    def setMarginType(self, margin: int, type: int) -> None: ...
    @overload
    ...
    def setMarginBackgroundColor(self, margin: int, col: typing.Union[QtGui.QColor, int]) -> None: ...
    def setIndicatorOutlineColor(self, col: typing.Union[QtGui.QColor, int], indicatorNumber: int = ...) -> None: ...
    def setIndicatorHoverStyle(self, style: int, indicatorNumber: int = ...) -> None: ...
    def setIndicatorHoverForegroundColor(self, col: typing.Union[QtGui.QColor, int], indicatorNumber: int = ...) -> None: ...
    def setIndicatorForegroundColor(self, col: typing.Union[QtGui.QColor, int], indicatorNumber: int = ...) -> None: ...
    ...
    def setHotspotForegroundColor(self, col: typing.Union[QtGui.QColor, int]) -> None: ...
    def setHotspotBackgroundColor(self, col: typing.Union[QtGui.QColor, int]) -> None: ...
    ...
    def setEdgeColor(self, col: typing.Union[QtGui.QColor, int]) -> None: ...
    def clearEdgeColumns(self) -> None: ...
    def addEdgeColumn(self, colnr: int, col: typing.Union[QtGui.QColor, int]) -> None: ...
    ...
    def setCallTipsStyle(self, style: int) -> None: ...
    def setCallTipsPosition(self, position: int) -> None: ...
    def setCallTipsHighlightColor(self, col: typing.Union[QtGui.QColor, int]) -> None: ...
    def setCallTipsForegroundColor(self, col: typing.Union[QtGui.QColor, int]) -> None: ...
    def setCallTipsBackgroundColor(self, col: typing.Union[QtGui.QColor, int]) -> None: ...
    ...
    def setAnnotationDisplay(self, display: int) -> None: ...
    def setFoldMarginColors(self, fore: typing.Union[QtGui.QColor, int], back: typing.Union[QtGui.QColor, int]) -> None: ...
    ...
    @overload
    def markerDefine(self, sym: int, markerNumber: int = ...) -> int: ...
    @overload
    ...
    def marginType(self, margin: int) -> int: ...
    ...
    def indicatorDefine(self, style: int, indicatorNumber: int = ...) -> int: ...
    ...
    def folding(self) -> int: ...
    def firstVisibleLine(self) -> int: ...
    def findMatchingBrace(self, mode: int) -> typing.Tuple[bool, int, int]: ...
    ...
    def convertEols(self, mode: int) -> None: ...
    ...
    def annotationDisplay(self) -> int: ...
...
class QsciAbstractAPIs(QtCore.QObject):
    ...
    def __init__(self, lexer: typing.Optional[QsciLexer] = ..., **props) -> None: ...

    def callTips(self, context: typing.Iterable[str], commas: int, style: int, shifts: typing.Iterable[int]) -> typing.List[str]: ...
...
class QsciAPIs(QsciAbstractAPIs):
    ...
    apiPreparationCancelled: PYQT_SIGNAL
    apiPreparationFinished: PYQT_SIGNAL
    apiPreparationStarted: PYQT_SIGNAL
...
class QsciCommand(sip.wrapper):
    ...
    Command: typing.Type[int]
    #class Command(int): ...
    LineDown = ... # type: int
    LineDownExtend = ... # type: int
    LineDownRectExtend = ... # type: int
    LineScrollDown = ... # type: int
    LineUp = ... # type: int
    LineUpExtend = ... # type: int
    LineUpRectExtend = ... # type: int
    LineScrollUp = ... # type: int
    ScrollToStart = ... # type: int
    ScrollToEnd = ... # type: int
    VerticalCentreCaret = ... # type: int
    ParaDown = ... # type: int
    ParaDownExtend = ... # type: int
    ParaUp = ... # type: int
    ParaUpExtend = ... # type: int
    CharLeft = ... # type: int
    CharLeftExtend = ... # type: int
    CharLeftRectExtend = ... # type: int
    CharRight = ... # type: int
    CharRightExtend = ... # type: int
    CharRightRectExtend = ... # type: int
    WordLeft = ... # type: int
    WordLeftExtend = ... # type: int
    WordRight = ... # type: int
    WordRightExtend = ... # type: int
    WordLeftEnd = ... # type: int
    WordLeftEndExtend = ... # type: int
    WordRightEnd = ... # type: int
    WordRightEndExtend = ... # type: int
    WordPartLeft = ... # type: int
    WordPartLeftExtend = ... # type: int
    WordPartRight = ... # type: int
    WordPartRightExtend = ... # type: int
    Home = ... # type: int
    HomeExtend = ... # type: int
    HomeRectExtend = ... # type: int
    HomeDisplay = ... # type: int
    HomeDisplayExtend = ... # type: int
    HomeWrap = ... # type: int
    HomeWrapExtend = ... # type: int
    VCHome = ... # type: int
    VCHomeExtend = ... # type: int
    VCHomeRectExtend = ... # type: int
    VCHomeWrap = ... # type: int
    VCHomeWrapExtend = ... # type: int
    LineEnd = ... # type: int
    LineEndExtend = ... # type: int
    LineEndRectExtend = ... # type: int
    LineEndDisplay = ... # type: int
    LineEndDisplayExtend = ... # type: int
    LineEndWrap = ... # type: int
    LineEndWrapExtend = ... # type: int
    DocumentStart = ... # type: int
    DocumentStartExtend = ... # type: int
    DocumentEnd = ... # type: int
    DocumentEndExtend = ... # type: int
    PageUp = ... # type: int
    PageUpExtend = ... # type: int
    PageUpRectExtend = ... # type: int
    PageDown = ... # type: int
    PageDownExtend = ... # type: int
    PageDownRectExtend = ... # type: int
    StutteredPageUp = ... # type: int
    StutteredPageUpExtend = ... # type: int
    StutteredPageDown = ... # type: int
    StutteredPageDownExtend = ... # type: int
    Delete = ... # type: int
    DeleteBack = ... # type: int
    DeleteBackNotLine = ... # type: int
    DeleteWordLeft = ... # type: int
    DeleteWordRight = ... # type: int
    DeleteWordRightEnd = ... # type: int
    DeleteLineLeft = ... # type: int
    DeleteLineRight = ... # type: int
    LineDelete = ... # type: int
    LineCut = ... # type: int
    LineCopy = ... # type: int
    LineTranspose = ... # type: int
    LineDuplicate = ... # type: int
    SelectAll = ... # type: int
    MoveSelectedLinesUp = ... # type: int
    MoveSelectedLinesDown = ... # type: int
    SelectionDuplicate = ... # type: int
    SelectionLowerCase = ... # type: int
    SelectionUpperCase = ... # type: int
    SelectionCut = ... # type: int
    SelectionCopy = ... # type: int
    Paste = ... # type: int
    EditToggleOvertype = ... # type: int
    Newline = ... # type: int
    Formfeed = ... # type: int
    Tab = ... # type: int
    Backtab = ... # type: int
...
class QsciCommandSet(sip.wrapper):
    ...
    def find(self, command: int) -> QsciCommand: ...
...
class QsciLexer(QtCore.QObject):
    ...
    eolFillChanged: PYQT_SIGNAL
    fontChanged: PYQT_SIGNAL
    paperChanged: PYQT_SIGNAL
    propertyChanged: PYQT_SIGNAL
    ...
    #def paperChanged(self, c: typing.Union[QtGui.QColor, int], style: int) -> None: ...
    #def fontChanged(self, f: QtGui.QFont, style: int) -> None: ...
    #def eolFillChanged(self, eolfilled: bool, style: int) -> None: ...
    #def colorChanged(self, c: typing.Union[QtGui.QColor, int], style: int) -> None: ...
    def setPaper(self, c: typing.Union[QtGui.QColor, int], style: int = ...) -> None: ...
    def setFont(self, f: QtGui.QFont, style: int = ...) -> None: ...
    def setEolFill(self, eolfill: bool, style: int = ...) -> None: ...
    def setColor(self, c: typing.Union[QtGui.QColor, int], style: int = ...) -> None: ...
    def setAutoIndentStyle(self, autoindentstyle: int) -> None: ...
    def writeSettings(self, qs: QtCore.QSettings, prefix: typing.Optional[str] = ...) -> bool: ...
    def readSettings(self, qs: QtCore.QSettings, prefix: typing.Optional[str] = ...) -> bool: ...
    def wordCharacters(self) -> str: ...
    def styleBitsNeeded(self) -> int: ...
    def setDefaultPaper(self, c: typing.Union[QtGui.QColor, int]) -> None: ...
    def setDefaultFont(self, f: QtGui.QFont) -> None: ...
    def setDefaultColor(self, c: typing.Union[QtGui.QColor, int]) -> None: ...
...
class QsciLexerCPP(QsciLexer):
    ...
    def __init__(self, parent: typing.Optional[QtCore.QObject] = ..., caseInsensitiveKeywords: bool = ..., **props) -> None: ...
...
class QsciLexerPython(QsciLexer):
    ...
    IndentationWarning: typing.Type[int]
    #class IndentationWarning(int): ...
    NoWarning = ... # type: int
    Inconsistent = ... # type: int
    TabsAfterSpaces = ... # type: int
    Spaces = ... # type: int
    Tabs = ... # type: int
    ...
    def writeProperties(self, qs: QtCore.QSettings, prefix: str) -> bool: ...
    def readProperties(self, qs: QtCore.QSettings, prefix: str) -> bool: ...
    def setIndentationWarning(self, warn: int) -> None: ...
    ...
    def indentationWarning(self) -> int: ...
...
class QsciMacro(QtCore.QObject):
    ...
    @overload
    def __init__(self, parent: QsciScintilla, **props) -> None: ...
    @overload
    def __init__(self, asc: str, parent: QsciScintilla, **props) -> None: ...
...
class QsciPrinter(QtPrintSupport.QPrinter):
    ...
    def setWrapMode(self, a0: int) -> None: ...
    def wrapMode(self) -> int: ...
...
class QsciStyle(sip.wrapper):
    ...
    TextCase: typing.Type[int]
    #class TextCase(int): ...
    OriginalCase = ... # type: int
    UpperCase = ... # type: int
    LowerCase = ... # type: int
    ...
    @overload
    def __init__(self, style: int, description: str, color: typing.Union[QtGui.QColor, int], paper: typing.Union[QtGui.QColor, int], font: QtGui.QFont, eolFill: bool = ...) -> None: ...
    @overload
    ...
    def textCase(self) -> int: ...
    def setTextCase(self, text_case: int) -> None: ...
    def eolFill(self) -> bool: ...
    def setEolFill(self, fill: bool) -> None: ...
    def font(self) -> QtGui.QFont: ...
    def setFont(self, font: QtGui.QFont) -> None: ...
    def paper(self) -> QtGui.QColor: ...
    def setPaper(self, paper: typing.Union[QtGui.QColor, int]) -> None: ...
    def color(self) -> QtGui.QColor: ...
    def setColor(self, color: typing.Union[QtGui.QColor, int]) -> None: ...
    def description(self) -> str: ...
