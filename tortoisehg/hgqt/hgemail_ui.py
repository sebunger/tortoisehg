...
# Form implementation generated from reading ui file '/home/steve/repos/thg/tortoisehg/hgqt/hgemail.ui'
#
...
class Ui_EmailDialog(object):
    def setupUi(self, EmailDialog):
        ...
        QtCore.QObject.connect(self.writeintro_check, QtCore.SIGNAL("toggled(bool)"), self.intro_box.setVisible)
        QtCore.QObject.connect(self.send_button, QtCore.SIGNAL("clicked()"), EmailDialog.accept)
        QtCore.QObject.connect(self.close_button, QtCore.SIGNAL("clicked()"), EmailDialog.close)
        QtCore.QObject.connect(self.writeintro_check, QtCore.SIGNAL("toggled(bool)"), self.subject_edit.setFocus)
