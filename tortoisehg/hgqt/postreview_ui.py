...
# Form implementation generated from reading ui file '/home/steve/repos/thg/tortoisehg/hgqt/postreview.ui'
#
...
class Ui_PostReviewDialog(object):
    def setupUi(self, PostReviewDialog):
        ...
        QtCore.QObject.connect(self.post_review_button, QtCore.SIGNAL("clicked()"), PostReviewDialog.accept)
        QtCore.QObject.connect(self.settings_button, QtCore.SIGNAL("clicked()"), PostReviewDialog.onSettingsButtonClicked)
        QtCore.QObject.connect(self.close_button, QtCore.SIGNAL("clicked()"), PostReviewDialog.close)
        QtCore.QObject.connect(self.outgoing_changes_check, QtCore.SIGNAL("toggled(bool)"), PostReviewDialog.outgoingChangesCheckToggle)
        QtCore.QObject.connect(self.branch_check, QtCore.SIGNAL("toggled(bool)"), PostReviewDialog.branchCheckToggle)
        QtCore.QObject.connect(self.tab_widget, QtCore.SIGNAL("currentChanged(int)"), PostReviewDialog.tabChanged)
